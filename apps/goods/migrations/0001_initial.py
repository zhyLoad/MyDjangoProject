    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identify', models.CharField(default='', help_text='门店标识号', max_length=30, verbose_name='门店标识号')),
                ('image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='图片')),
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.Address', verbose_name='门店地址')),
