    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identify', models.CharField(default=uuid.UUID('886313e1-3b8a-5372-9b90-0c9aee199e5d'), help_text='门店标识号', max_length=30, verbose_name='门店标识号')),
                ('image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='图片')),
                ('opening_time', models.TimeField(blank=True, null=True, verbose_name='开始营业时间')),
                ('closing_time', models.TimeField(blank=True, null=True, verbose_name='关门时间')),
                ('mobile', models.CharField(blank=True, help_text='电话号码', max_length=11, null=True, verbose_name='电话')),
                ('score', models.IntegerField(default=0, null=True, verbose_name='门店评分')),
                ('brief_introduce', models.TextField(max_length=500, null=True, verbose_name='门店简介')),
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.Addresses', verbose_name='门店地址')),
