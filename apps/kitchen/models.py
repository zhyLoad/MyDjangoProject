...
class KitchenSink(models.Model):
    ...
    country = models.ForeignKey(Country, on_delete=models.CASCADE, related_name='foreign_key_country')
    linked_foreign_key = models.ForeignKey(Country,on_delete=models.CASCADE, limit_choices_to={
